...
struct SVGWebView: UIViewRepresentable {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
      ...
      <g id="dust">
        ...
        <circle cx="50" cy="230" r="1.5" fill="#000000" opacity="0.6">
        ...
        <circle cx="60" cy="225" r="2.5" fill="#000000" opacity="0.5">
        ...
        <circle cx="200" cy="220" r="2" fill="#000000" opacity="0.7">
        ...
        <circle cx="210" cy="230" r="1.5" fill="#000000" opacity="0.6">
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        """
        webView.loadHTMLString(modifiedSVG, baseURL: nil)
        return webView
    }
